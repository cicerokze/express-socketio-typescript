...
4. You can test with different devices, but make sure your devices are in the same network (it might be your WiFi).
...
## Example: <a href="https://cicerokze-exsots-185454f44c0f.herokuapp.com/" target="_blank">express-socketio-typescript</a>
